...
@torch.no_grad()
def run(weights= 'charregbest.pt',  # model.pt path(s)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='charregbest.pt', help='model path(s)')
